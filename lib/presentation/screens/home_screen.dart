...
class _HomeScreenState extends ConsumerState<HomeScreen> 
  ...
  Widget _buildTasksCard() {
    ...
    if (!weightRecorded) {
      ...
      primaryTaskAction = () => _showWeightRecordDialog();
...
class _WeightRecordDialog extends ConsumerStatefulWidget {
  final VoidCallback onSaved;

  const _WeightRecordDialog({required this.onSaved});

  @override
  ConsumerState<_WeightRecordDialog> createState() => _WeightRecordDialogState();
}

class _WeightRecordDialogState extends ConsumerState<_WeightRecordDialog> {
